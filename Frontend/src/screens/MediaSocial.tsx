					...
					<div className="card-body">
						...
						{statsError && (
							<div role="alert" className="alert alert-error mb-4">
								<span>
									{(statsError as Error)?.message || 'Failed to load media stats'}
								</span>
								...
								<div className="card bg-base-100 shadow-lg mb-6">
									<div className="card-body">
										...
										{globalLogsError && (
											<div role="alert" className="alert alert-error mb-4">
												<span>
													{(globalLogsError as Error)?.message || 'Failed to load recent activity'}
												</span>
												<button className="btn btn-sm" onClick={() => refetchGlobalLogs()}>
													Retry
												</button>
											</div>
										)}
															...
															<div className="flex items-center gap-4">
																...
																<div className="flex-1">
																	...
																	<div className="skeleton h-3 w-1/2" />
																							...
																							{globalLogs.map((log) => {
																								const logWithUser = log as unknown as { user?: { username?: string; avatar?: string } };
																				...
																				<div className="flex items-center gap-2 text-sm text-base-content/70">
																					{avatar ? (
																						...
																						<div className="w-6 h-6 rounded-full bg-base-300" />
																											...
																											{uname ? (
																												<Link to={`/user/${encodeURIComponent(uname)}`} className="link link-hover">
																													@{uname}
																												</Link>
																											) : (
																												<span>@unknown</span>
