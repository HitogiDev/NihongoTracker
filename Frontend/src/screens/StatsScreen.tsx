    ...
    <div className="min-h-screen pt-16 bg-base-200">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          {/* Episodes (for anime/video/movie) */}
          {(currentType === 'anime' ||
            currentType === 'video' ||
            currentType === 'movie') && (
            <div className="card bg-base-100 shadow-lg">
          ...
          {/* Pages (for manga/reading) */}
          {(currentType === 'manga' || currentType === 'reading') && (
            <div className="card bg-base-100 shadow-lg">
              <div className="card-body">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 bg-info/10 rounded-lg flex items-center justify-center">
                ...
                <p className="text-2xl font-bold">
                  {(() => {
                    ...
                    return numberWithCommas(typeStats?.totalPages || 0);
                  })()}
                </p>
                <p className="text-xs text-base-content/60 mt-1">
                  Total pages read in {currentType}
                </p>
              </div>
            </div>
          )}
