          ...
          <div className="modal-box max-w-2xl">
            ...
            >
              ...
              <div>
                ...
                <div className="label">
                  <span className="label-text-alt">Recommended: Square image, max 5MB</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="label">
                  <span className="label-text-alt">Recommended: 16:9 aspect ratio, max 5MB</span>
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({ ...editForm, memberLimit: parseInt(e.target.value) || 100 })
                  }
                  min={1}
                  max={1000}
                />
              ...
              <div>
                ...
                <div className="label">
                  <span className="label-text-alt">
                    Separate tags with commas (e.g., beginner, anime, study-group)
                  </span>
                </div>
              </div>
              ...
              <div className="modal-action">
                ...
                <button
                  type="submit"
                  className="btn btn-primary"
                  disabled={updateClubMutation.isPending || !editForm.name.trim()}
                >
