...
const TermsOfServiceScreen: React.FC = () => {
  return (
    <div className="min-h-screen bg-base-100 pt-32 pb-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>
              By creating an account or using NihongoTracker, you acknowledge
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              obtained permission from your parent or legal guardian to use this
              Service.
            </p>
            <p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              NihongoTracker allows you to create and share content, including
              but not limited to profile information, avatar images, immersion
              logs, reviews, and comments ("User Content"). You retain ownership
              of your User Content, but by posting it on our Service, you grant
              us a worldwide, non-exclusive, royalty-free license to use,
              display, reproduce, and distribute your User Content in connection
            ...
            <p>
              ...
              at our sole discretion and without prior notice. However, we are
              not obligated to monitor all User Content and are not responsible
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                Manipulate statistics, XP, or other game elements through
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-4">6.1 Our Content</h3>
            <p className="mb-4">
            ...
            <p>
              ...
              claim ownership of any third-party content displayed on our
              Service.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              on our Support page. We reserve the right to modify, add, or
              remove benefits at any time, though we will make reasonable
            ...
            <p className="mb-4">
              ...
              Patreon account in your Settings using the email address
              associated with your Patreon account. Benefits are applied
              automatically via webhooks and may take a few minutes to activate.
            </p>
            ...
            <p className="mb-4">
              ...
              Patreon. Upon cancellation, you will retain your benefits until
              the end of your current billing period, after which they will be
          ...
          <section className="mb-8">
            ...
            <p>
              You agree to indemnify, defend, and hold harmless NihongoTracker
              ...
              in any way connected with: (a) your access to or use of the
              Service; (b) your User Content; (c) your violation of these Terms;
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              While we make reasonable efforts to maintain and back up your
              data, we cannot guarantee against data loss or corruption. You are
              responsible for maintaining your own backups of any important
              data. We are not liable for any loss of data or User Content.
            </p>
            <p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              page. Upon deletion, your User Content and personal data will be
              removed from our servers, except as required by law or for
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              relief in court to prevent infringement of intellectual property
              rights.
            </p>
          </section>
          ...
          <div className="border-t border-base-300 pt-8 mt-12">
            <p className="text-center text-sm opacity-70">
              By using NihongoTracker, you acknowledge that you have read,
