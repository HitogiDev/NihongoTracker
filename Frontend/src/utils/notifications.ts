...
const ICONS: Record<NotificationKind, LucideIcon> = {
  ...
  follow: UserPlus,
  activity_reaction: Heart,
  activity_comment: MessageCircle,
  media_recommendation: BookOpen,
  ...
  media_request_approved: Star,
  media_request_rejected: Star,
...
const ACCENTS: Partial<Record<NotificationKind, string>> = {
  ...
  activity_reaction: 'text-error bg-error/10',
  activity_comment: 'text-info bg-info/10',
  media_recommendation: 'text-primary bg-primary/10',
...
const BADGE_ACCENTS: Partial<Record<NotificationKind, string>> = {
  ...
  activity_reaction: 'bg-error text-error-content',
  activity_comment: 'bg-info text-info-content',
  media_recommendation: 'bg-primary text-primary-content',
